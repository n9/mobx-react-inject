...
/***/ function(module, exports, __webpack_require__) {
	...
	StoreProvider.contextTypes = {
	    storeContainer: React.PropTypes.instanceOf(StoreContainer_1.StoreContainer)
	};
	StoreProvider.childContextTypes = {
	    storeContainer: React.PropTypes.instanceOf(StoreContainer_1.StoreContainer).isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	function propertyDecorator(target, propertyName) {
	    ...
	    if (targetConstructor.contextTypes.storeContainer == null) {
	        targetConstructor.contextTypes.storeContainer = React.PropTypes.instanceOf(StoreContainer_1.StoreContainer).isRequired;
	    }
